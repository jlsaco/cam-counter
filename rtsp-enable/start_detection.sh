...
# 0) Resolver la credencial de la camara (env CAM_PASS o fichero gitignored rtsp-enable/CAM_PASS).
#    Falla rapido y limpio si no esta disponible: no tiene sentido escanear la red sin credencial.
