...
ancladas a `media/` y sin `..`/barra inicial/doble barra/backslash. La firma es local (SigV4),
así que no requiere AWS real; basta con credenciales ficticias en el entorno.
"""
